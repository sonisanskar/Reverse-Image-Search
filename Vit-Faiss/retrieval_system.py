...
class ImageRetrievalSystem:
    ...
    def index_images(self, 
        ...
        all_features =  np.stack(features_list).astype(np.float32)
        logger.debug(f"type of all_features: {type(all_features)}")
        logger.debug(f"dtype of all_features: {all_features.dtype}")
        logger.debug(f"shape of all_features: {all_features.shape}")
